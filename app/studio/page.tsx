...
export default function Home() {
  ...
  async function suggestJobs() {
    ...
    try {
      const searchPayload = {
        ...
        instructions:
          "Hae vain oikeasti NYT avoinna olevia, aitoja ty?paikkoja useista l?hteist?. ?l? keksi ilmoituksia ?l?k? palauta vanhoja (esim. vuodelta 2024 tai 2025).",
      };
  ...
  async function sendSparringMessage(e: React.FormEvent) {
    ...
    try {
      ...
      setSparringChat([...newChat, { role: "ai", text: "Yhteysvirhe ? tarkista internetyhteys ja yrit? uudelleen." }]);
    } finally {
  ...
  async function translateSkills() {
    ...
    try {
      ...
      setErrorMessage("Yhteysvirhe ? yrit? uudelleen.");
    } finally {
  ...
  async function runAtsScan(job: JobItem) {
    ...
    try {
      ...
      setErrorMessage("ATS-skannaus ep?onnistui ? yrit? uudelleen.");
    } finally {
  ...
  async function generateInterviewPrep(job: JobItem) {
    ...
    try {
      ...
      setErrorMessage("Haastattelukysymysten generointi ep?onnistui ? yrit? uudelleen.");
    } finally {
      setIsPrepping(false);
    }
  }
  ...
  >
    ...
    <span>Pro</span>
        ...
        <section className="relative overflow-hidden border-b border-white/10 bg-[linear-gradient(180deg,rgba(22,22,22,0.98),rgba(12,12,12,0.94))]" aria-labelledby="hero-heading">
          ...
          <div className="relative mx-auto w-full max-w-[1680px] px-4 sm:px-6 lg:px-8 xl:px-10 py-12 sm:py-14 lg:py-16">
