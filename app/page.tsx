      ...
      <section className="mx-auto max-w-[1280px] px-4 md:px-6 pb-20">
        <div ref={r6} className="opacity-0 translate-y-6 transition-all duration-700">
          <GlassCard className="px-6 py-12 md:px-14 md:py-16 text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-base md:text-lg leading-relaxed text-zinc-400">{tx.ctaDesc}</p>
            <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
              ...
              <Link href="#features" className="rounded-xl border border-white/10 bg-white/[0.04] px-6 py-3 text-sm font-semibold text-white transition hover:bg-white/[0.08]">{tx.ctaBtn2}</Link>
            </div>
          </GlassCard>
        </div>
      </section>
